    ...
    return (
        <>
            <div style={{ margin: '0px 310px' }}>
                <h1 className='glow-on-hover' style={{ margin: '5px 0px', width: '450px', textAlign: 'center' }}>Ayush Kumar Baranwal</h1>
                {/* <h1 className='animate-character' style={{margin : '5px 0px',fontSize:'50px', textAlign:'center'}}>Ayush Kumar Baranwal</h1> */}
                <img src='Ayush.jpg' style={{ float: 'right', width: '400px', height: '432px', marginLeft: "2px" }}></img>
                <br></br>

        ...
        <>
            {props.mobile === false ?
                <div style={{ margin: '0px 20%' }}>
                    ...
                    <br></br>
                    <p style={{ textAlign: 'justify', marginBottom: '25px', fontSize:'18px' }}>
                ...
                <div style={{ margin: '0px 5%' }}>
                    <center>
                        <h1 className='glow-on-hover' style={{ marginTop: '0.5%', width: '98%', textAlign: 'center', paddingTop: '0.75%', marginBottom: '4%' }}>Ayush Kumar Baranwal</h1>
                    </center>
                    {/* <h1 className='animate-character' style={{margin : '5px 0px',fontSize:'50px', textAlign:'center'}}>Ayush Kumar Baranwal</h1> */}

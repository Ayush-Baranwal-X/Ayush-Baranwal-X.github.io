        ...
        <div style={{ marginLeft: props.mobile === false ? '19.5%' : '5%', marginRight: props.mobile === false ? '19.5%' : '5%' }}>
            ...
            <Accordion defaultActiveKey={['0']} alwaysOpen>
                <Accordion.Item eventKey="0">
                    <Accordion.Header><b>Dmail (Email Website)</b></Accordion.Header>
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://dmail.pythonanywhere.com/' target='_blank' >www.dmail.pythonanywhere.com</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://rail.pythonanywhere.com/' target='_blank' >www.rail.pythonanywhere.com</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://github.com/Ayush-Baranwal-X/Real-Estate-Price-Prediction' target='_blank' >www.github.com/Ayush-Baranwal-X/Real-Estate-Price-Prediction</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="3">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://ayushbaranwal.itch.io/driverclub' target='_blank' >www.ayushbaranwal.itch.io/driverclub</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="4">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://github.com/Ayush-Baranwal-X/Credit-Card-Fraud-Detection' target='_blank' >www.github.com/Ayush-Baranwal-X/Credit-Card-Fraud-Detection</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="5">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://github.com/Ayush-Baranwal-X/Quiz' target='_blank' >www.github.com/Ayush-Baranwal-X/Quiz</Link>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="6">
                    ...
                    <Accordion.Body>
                        ...
                        <br></br>
                        <br></br>
                        You can visit it at : <Link style={{ color: 'black', textDecoration: 'none' }} to='https://github.com/Ayush-Baranwal-X/Cookie-Clicker-Bot' target='_blank' >www.github.com/Ayush-Baranwal-X/Cookie-Clicker-Bot</Link>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
        </div>
